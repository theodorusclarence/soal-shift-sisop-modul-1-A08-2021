...
2. Kemudian kami juga menambahkan `if (NR == 1) next` untuk skip line 1 kagrena berupa header.
...
2. kami menggunakan command `rm *.jpg.*` untuk menghapus foto yang duplikat dengan tetap menyisakan foto awal.  
